...
LLM_CACHE_PATH    = BASE_DIR / "cache" / "llm_analysis.json"
SUBMISSIONS_PATH  = BASE_DIR / "submission.csv"
DEFAULT_CANDIDATES_PATH = BASE_DIR / "candidates_data.json"
FRONTEND_CANDIDATES_PATH = BASE_DIR / "frontend" / "public" / "candidates_data.json"
...
def load_profiles(candidate_ids: frozenset):
    ...
    candidates_path = DEFAULT_CANDIDATES_PATH if DEFAULT_CANDIDATES_PATH.exists() else FRONTEND_CANDIDATES_PATH
